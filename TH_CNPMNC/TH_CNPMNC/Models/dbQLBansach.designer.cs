...
namespace TH_CNPMNC.Models
{
    ...
    partial void InsertQUANGCAO1(QUANGCAO1 instance);
    partial void UpdateQUANGCAO1(QUANGCAO1 instance);
    partial void DeleteQUANGCAO1(QUANGCAO1 instance);
    ...
    partial void DeleteVIETSACH(VIETSACH instance);
		...
		public System.Data.Linq.Table<QUANGCAO1> QUANGCAO1s
		{
			get
			{
				return this.GetTable<QUANGCAO1>();
			}
		}
    ...
    partial void OnThanhtienChanged();
			...
			set
			{
				if ((this._SoDH != value))
				{
					if (((this._DONDATHANG.HasLoadedOrAssignedValue || this._DONDATHANG1.HasLoadedOrAssignedValue) 
								|| this._SACH.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnSoDHChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DONDATHANG1_CTDATHANG", Storage="_DONDATHANG1", ThisKey="SoDH", OtherKey="SoDH", IsForeignKey=true)]
    ...
    partial void OnHTGiaohangChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DONDATHANG1_CTDATHANG", Storage="_CTDATHANGs", ThisKey="SoDH", OtherKey="SoDH")]
		public EntitySet<CTDATHANG> CTDATHANGs
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.QUANGCAO")]
	public partial class QUANGCAO1 : INotifyPropertyChanging, INotifyPropertyChanged
	{
